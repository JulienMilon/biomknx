...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "R Package To Help In Data Processing, 2D And 3D Plot For Biomechanics.",
    Description = "Utilisez biomknx pour vos calculs, le traitement et la visualisation de vos données dans le domaines de la biomécanique. Les fonctions de ce package permettent de faciliter les calculs dans la géométrie 'Humaine', créer des graphiques 2D et 3D pour étudier le mouvement 'Humaine'.",
    `Authors@R` = person("Julien", "MILON", email = "julien.milon@mines-ales.org", role = c("aut", "cre"))
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Julien MILON")
```
